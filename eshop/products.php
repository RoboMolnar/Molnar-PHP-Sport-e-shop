...
<html lang="en">
  ...
  <head>
    ...
    <title>Oceľové svaly - Produkty</title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="filters">
              <ul>
                  <li class="active" data-filter="*">Všetky produkty</li>
                  <li data-filter=".des">Proteíny</li>
                  <li data-filter=".dev">Gainery</li>
                  <li data-filter=".gra">Vitamíny</li>
              </ul>
            </div>
          </div>
          <div class="col-md-12">
            <div class="filters-content">
                <div class="row grid">
                    ...
                    <div class="col-lg-4 col-md-4 all des">
                      <div class="product-item">
                        <a href="#"><img src="assets/images/protein2.png" alt=""></a>
                        <div class="down-content">
                          <a href="#"><h4>Protein2</h4></a>
                          <h6>€520.70</h6>
                          <p>Lorem ipsume dolor sit amet, adipisicing elite. Itaque, corporis nulla aspernatur.</p>
                          <ul class="stars">
                            <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="col-lg-4 col-md-4 all dev">
                      <div class="product-item">
                        <a href="#"><img src="assets/images/gainer2.png" alt=""></a>
                        <div class="down-content">
                          <a href="#"><h4>Gainer2</h4></a>
                          <h6>€94.30</h6>
                          <p>Lorem ipsume dolor sit amet, adipisicing elite. Itaque, corporis nulla aspernatur.</p>
                          <ul class="stars">
                            <li><i class="fa fa-star"></i></li>
                    ...
                    <div class="col-lg-4 col-md-4 all gra">
                      <div class="product-item">
                        <a href="#"><img src="assets/images/vit.png" alt=""></a>
                        <div class="down-content">
                          <a href="#"><h4>Vitamin1</h4></a>
                          <h6>€47.20</h6>
                          <p>Lorem ipsume dolor sit amet, adipisicing elite. Itaque, corporis nulla aspernatur.</p>
                          <ul class="stars">
                            <li><i class="fa fa-star"></i></li>
